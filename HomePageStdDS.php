...
<body>
    ...
    <script>
        function openContent(option) {
            ...
            if (option === 'dashboard') {
                content = `
                <h2>Quiz Marks</h2>
                <a href="QimarkDS.php">Click here to check marks</a>
                `;
            } else if (option === 'students') {
                content = `
                <h2>Assignment Marks</h2>
                <a href="AsmarksDS.php">Click here to check marks</a>
                `;
            } else if (option === 'courses') {
                content = `
                <h2>Attendance</h2>
                <a href="AttDS.php">Click here to check Attendance</a>
                `;
            } else if (option === 'final-grade') {
                content = `
                <h2>Final Grade</h2>
                <a href="FmarksDS.php">Click here to check Final Grade</a>
                `;
  ...
  content = `
    ...
    <div class="form-container">
      ...
      <form action="UpdatePassDS.php" method="POST">
