...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO quizmarks_ai (StudentID,QiMarks1,QiMarks2,QiMarks3,QiMarks4,CourseID)
            VALUES ('$StudentID','$QuizMarks1','$QuizMarks2','$QuizMarks3','$QuizMarks4','$CourseID')";

    if (mysqli_query($conn, $sql)) {
        echo "<h1 style='color: green; text-align: center; font-family: Arial, sans-serif; background-color: #f0f0f0; padding: 20px; border-radius: 10px;'>Quiz marks added successfully.</h1>";
    } else {
